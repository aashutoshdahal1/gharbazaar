...
const EditProfile = () => {
  ...
  const handleBackClick = () => {
    // Option 1: If you're using React Router, uncomment the line below and import useNavigate
    // navigate('/dashboard');
    
    // Option 2: Using browser's native navigation
    window.history.back();
    
    // Option 3: Direct URL navigation (replace with your dashboard URL)
    // window.location.href = '/dashboard';
    
    // Option 4: If dashboard is the previous page in history
    // window.history.go(-1);
  };
